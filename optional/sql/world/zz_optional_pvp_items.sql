...
-- Potential missing items for Officer Areyn
...
UPDATE `creature_template` SET `ScriptName` = "npc_ipp_pvp_vendor_pre_tbc" WHERE `entry` IN (12799,12805,12777,26394,26396,12792,112781,112785,112793,112794,112795);
