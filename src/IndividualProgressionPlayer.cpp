...
public:
    ...
    void OnPlayerLearnSpell(Player* player, uint32 spellID) override
    {
        ...
        for (uint32 demonSpellID : {20270, 20312, 20313, 20314, 20315, 20314, 27487,
                                    20397, 20318, 20319, 20320, 20321, 27488,
                                    20322, 20323, 20324, 20326, 20327, 27489,
                                    20329,
                                    20317, 20377, 20378, 20379, 20380, 27490,
                                    20381, 20382, 20383, 20384, 20385, 20386, 27492,
                                    20387, 20388, 20389, 20390, 20391, 20392, 27491,
                                    20393, 20394, 20395, 20396, 27500, 33703,
                                    20398, 20399, 20400, 20401, 20402, 27493,
                                    20403, 20404, 20405, 20406, 27494,
                                    20426, 20427, 20428, 27495, 27496,
                                    20429, 20430, 20431, 20432, 27497,
                                    20433, 20434,
                                    30154, 30199, 30200,
                                    30214, 30222, 30224,
                                    33704, 33705, 33706,
