...
public:
    ...
    bool enabled, questXpFix, hunterPetLevelFix, enforceGroupRules, fishingFix, WarlockDemonTrainers, simpleConfigOverride, questMoneyAtLevelCap, repeatableVanillaQuestsXp, disableDefaultProgression, earlyDungeonSet2, requireNaxxStrath, pvpGearRequirements, DisableRDF, excludeAccounts;
