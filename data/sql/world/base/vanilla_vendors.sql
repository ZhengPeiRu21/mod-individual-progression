...
(23, 3499,  20855, 0, 0, 8, 0, 66013, 0, 0, 0, 0, 0, '', 'Ranik - Design: Wicked Moonstone Ring'),
...
DELETE FROM `npc_vendor` WHERE `item` = 4471  AND `entry` IN (151, 227, 491, 734, 791, 1149, 1250, 1448, 1452, 1682, 1685, 1691, 2084, 2134, 2140, 2401, 2803, 2806, 2808, 2820, 2908, 
...
DELETE FROM npc_vendor WHERE `entry` = 12792 AND `item` IN (29612, 29613, 29614, 29615, 29616, 29617, 29600, 29601, 29602, 29603, 29604, 29605);
...
DELETE FROM npc_vendor WHERE `entry` = 12777 AND `item` IN (29608, 29606, 29611, 29609, 29607, 29610, 29595, 29599, 29597, 29596, 29598, 29594);
INSERT INTO npc_vendor (entry, slot, item, maxcount, incrtime, ExtendedCost, VerifiedBuild) VALUES
