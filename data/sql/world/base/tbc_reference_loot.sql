DELETE FROM `reference_loot_template` WHERE `Entry` IN (12005, 34052, 36098, 36196, 36197, 36198, 36199, 50501);
...
--
(12005, 32227, 0, 0, 0, 1, 1, 1, 1, 'Crimson Spinel'),
(12005, 32228, 0, 0, 0, 1, 1, 1, 1, 'Empyrean Sapphire'),
(12005, 32229, 0, 0, 0, 1, 1, 1, 1, 'Lionseye'),
(12005, 32230, 0, 0, 0, 1, 1, 1, 1, 'Shadowsong Amethyst'),
(12005, 32231, 0, 0, 0, 1, 1, 1, 1, 'Pyrestone'),
(12005, 32249, 0, 0, 0, 1, 1, 1, 1, 'Seaspray Emerald'),
--
