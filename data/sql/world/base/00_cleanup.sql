...
-- UNDO old 2.3 TBC phasing
UPDATE `creature_template` SET `ScriptName` = '' WHERE `entry` = 19227;

-- UNDO old 2.4 TBC phasing
UPDATE `creature` SET `ScriptName` = '' WHERE `ScriptName` = 'npc_suns_reach_reclamation_ipp_tbc_t5';
