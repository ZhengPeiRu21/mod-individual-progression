...
(@CGUID+315, 14187, 0, 0, 30, 0, 0, 1, 1, 0, 648.363, -65.2233, 41.7405, 3.12414, 120, 0, 0, 3052, 0, 0, 0, 0, 0, '', NULL, 0, NULL),      -- Athramanis <Bounty Hunter>
(@CGUID+316, 14188, 0, 0, 30, 0, 0, 1, 1, 0, 648.238, -67.8931, 41.7405, 2.60054, 120, 0, 0, 2961, 0, 0, 0, 0, 0, '', NULL, 0, NULL),      -- Dirk Swindle <Bounty Hunter>
(@CGUID+317, 13257, 0, 0, 30, 0, 0, 1, 1, 0, 647.61, -61.1548, 41.7405, 4.24115, 720, 0, 0, 30520, 0, 0, 0, 0, 0, '', NULL, 0, NULL);      -- Murgot Deepforge
...
(@CGUID+415, 14185, 0, 0, 30, 0, 0, 1, 1, 0, -1271.21, -335.554, 62.4462, 5.75959, 120, 0, 0, 2961, 0, 0, 0, 0, 0, '', NULL, 0, NULL),       -- Najak Hexxen <Bounty Hunter>
(@CGUID+416, 14186, 0, 0, 30, 0, 0, 1, 1, 0, -1268.64, -332.688, 62.7388, 5.28835, 120, 0, 0, 3052, 0, 0, 0, 0, 0, '', NULL, 0, NULL),       -- Ravak Grimtotem <Bounty Hunter>
(@CGUID+417, 13176, 0, 0, 30, 0, 0, 1, 1, 0, -1251.5, -316.327, 62.6565, 5.02655, 720, 0, 0, 30520, 0, 0, 0, 0, 0, '', NULL, 0, NULL),       -- Smith Regzar
--
...
-- Winterax Hold
(@CGUID+501, 12159, 0, 0, 30, 0, 0, 1, 1, 0, -256.68, -301.7, 6.7, 3.44473, 432000, 0, 0, 113295, 0, 0, 0, 0, 0, '', NULL, 0, NULL),      -- Korrak the Bloodrager (should spawn after 2 hours)
...
DELETE FROM `creature_addon` WHERE `guid` IN (@CGUID+301, @CGUID+307, @CGUID+309, @CGUID+310, @CGUID+408, @CGUID+409, CGUID+425, CGUID+426);
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `visibilityDistanceType`, `auras`) VALUES 
--
...
DELETE FROM `waypoint_data` WHERE `id` IN (@WPID+4250, @WPID+4260);
INSERT INTO `waypoint_data` (`id`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `delay`, `move_type`, `action`, `action_chance`, `wpguid`) VALUES 
--
