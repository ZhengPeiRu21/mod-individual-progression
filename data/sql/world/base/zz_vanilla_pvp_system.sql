/*
    Working Vanilla items with Vanilla PvP rank system in Azerothcore 3.3.5 for Mod-Individual-Progression module
*/

DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 23 AND `SourceGroup` IN (12777, 12782, 12783, 26394);
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` = 23 AND `SourceGroup` IN (12792, 12796, 14581, 26396, 26397);
...
-- We use some fully working conditions instead
...
(23, 112793, 18607, 0, 0, 18, 0, 23, 0, 0, 0, 0, 0, '', 'Vanilla PvP Ranked Gear (IPP)'); -- Horde Battle standards

-- During Vanilla, PvP items should cost gold, not honor points
-- Delete duplicate before update
DELETE FROM `npc_vendor` WHERE entry IN (12799,26396,12792,112793,112794,112795,12805,12777,26394,112781,112783,112785,112796)
AND `ExtendedCost` <> (SELECT MIN(ec.`ExtendedCost`) FROM (SELECT `entry`, `item`, `ExtendedCost` FROM `npc_vendor`) AS ec WHERE ec.`entry` = `npc_vendor`.`entry` AND ec.`item` = `npc_vendor`.`item`);
...
18241,18242,18243,18244, -- Vanilla PvP Mounts
18245,18246,18247,18248); -- Vanilla PvP Mounts

-- Vanilla PvP vendors phasing
UPDATE `creature_template` SET `ScriptName` = "npc_ipp_pvp_vendor_pre_tbc"
WHERE `entry` IN (12799,12805,12777,26394,26396,12792,112781,112783,112785,112793,112794,112795,112796);
