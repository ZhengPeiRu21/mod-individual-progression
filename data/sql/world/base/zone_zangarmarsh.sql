...
-- fix Diaphanous Wing drops (weren't dropping correctly)
UPDATE `creature_loot_template` SET `GroupId` = 2 WHERE `Item` = 24372 AND `entry` IN (18132, 18133, 18283, 20197, 20198);
