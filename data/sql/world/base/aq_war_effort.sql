...
(@OGUID+6,  180813, 1, 0, 0, 1, @IPPPHASE, 1590.82, -4155.33, 36.2926, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- skins - 1
(@OGUID+7,  180819, 1, 0, 0, 1, @IPPPHASE, 1637.11, -4147.21, 36.0414, 3.73501, 0, 0, -0.956305, 0.292372, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- herbs - 1
(@OGUID+8,  180827, 1, 0, 0, 1, @IPPPHASE, 1579.35, -4109.25, 34.5417, 3.75246, 0, 0, -0.953716, 0.300708, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 1
(@OGUID+9,  180833, 1, 0, 0, 1, @IPPPHASE, 1619.83, -4092.43, 34.5107, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- cooking - 1
(@OGUID+10, 180839, 1, 0, 0, 1, @IPPPHASE, 1683.11, -4134.35, 39.5419, 3.71755, 0, 0, -0.958819, 0.284016, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bars - 1
(@OGUID+11, 180815, 1, 0, 0, 1, @IPPPHASE_II, 1590.82, -4155.33, 36.2926, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- skins - 3
(@OGUID+12, 180821, 1, 0, 0, 1, @IPPPHASE_II, 1637.11, -4147.21, 36.0414, 3.73501, 0, 0, -0.956305, 0.292372, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- herbs - 3
(@OGUID+13, 180829, 1, 0, 0, 1, @IPPPHASE_II, 1579.35, -4109.25, 34.5417, 3.75246, 0, 0, -0.953716, 0.300708, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 3
(@OGUID+14, 180835, 1, 0, 0, 1, @IPPPHASE_II, 1619.83, -4092.43, 34.5107, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- cooking - 3
(@OGUID+15, 180841, 1, 0, 0, 1, @IPPPHASE_II, 1683.11, -4134.35, 39.5419, 3.71755, 0, 0, -0.958819, 0.284016, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bars - 3
(@OGUID+16, 180817, 1, 0, 0, 1, @IPPPHASE_III, 1590.82, -4155.33, 36.2926, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- skins - 5
(@OGUID+17, 180823, 1, 0, 0, 1, @IPPPHASE_III, 1637.11, -4147.21, 36.0414, 3.73501, 0, 0, -0.956305, 0.292372, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- herbs - 5
(@OGUID+18, 180831, 1, 0, 0, 1, @IPPPHASE_III, 1579.35, -4109.25, 34.5417, 3.75246, 0, 0, -0.953716, 0.300708, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 5
(@OGUID+19, 180837, 1, 0, 0, 1, @IPPPHASE_III, 1619.83, -4092.43, 34.5107, 3.7001, 0, 0, -0.961261, 0.27564, 180, 100, 1, 'gobject_ipp_we', 0, NULL),   -- cooking - 5
(@OGUID+20, 180843, 1, 0, 0, 1, @IPPPHASE_III, 1683.11, -4134.35, 39.5419, 3.71755, 0, 0, -0.958819, 0.284016, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bars - 5
-- Alliance
(@OGUID+21, 180598, 0, 0, 0, 1, 1, -4971.55, -1148.57, 501.648, 2.28638, 0, 0, 0.909961, 0.414693, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages
(@OGUID+22, 180681, 0, 0, 0, 1, 1, -4958.51, -1179.32, 501.659, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- skins
(@OGUID+23, 180680, 0, 0, 0, 1, 1, -4913.85, -1226, 501.651, 2.25148, 0, 0, 0.902585, 0.430511, 180, 100, 1, 'gobject_ipp_we', 0, NULL),    -- bars
(@OGUID+24, 180679, 0, 0, 0, 1, 1, -4937.29, -1282.74, 501.672, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL); -- cooking and herbs
(@OGUID+25, 180674, 0, 0, 0, 1, @IPPPHASE, -4971.55, -1148.57, 501.648, 2.28638, 0, 0, 0.909961, 0.414693, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 1
(@OGUID+26, 180692, 0, 0, 0, 1, @IPPPHASE, -4958.51, -1179.32, 501.659, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- skins - 1
(@OGUID+27, 180780, 0, 0, 0, 1, @IPPPHASE, -4913.85, -1226, 501.651, 2.25148, 0, 0, 0.902585, 0.430511, 180, 100, 1, 'gobject_ipp_we', 0, NULL),    -- bars - 1
(@OGUID+28, 180800, 0, 0, 0, 1, @IPPPHASE, -4937.29, -1282.74, 501.672, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- cooking and herbs - 1
(@OGUID+29, 180676, 0, 0, 0, 1, @IPPPHASE_II, -4971.55, -1148.57, 501.648, 2.28638, 0, 0, 0.909961, 0.414693, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 3
(@OGUID+30, 180694, 0, 0, 0, 1, @IPPPHASE_II, -4958.51, -1179.32, 501.659, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- skins - 3
(@OGUID+31, 180782, 0, 0, 0, 1, @IPPPHASE_II, -4913.85, -1226, 501.651, 2.25148, 0, 0, 0.902585, 0.430511, 180, 100, 1, 'gobject_ipp_we', 0, NULL),    -- bars - 3
(@OGUID+32, 180802, 0, 0, 0, 1, @IPPPHASE_II, -4937.29, -1282.74, 501.672, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- cooking and herbs - 3
(@OGUID+33, 180678, 0, 0, 0, 1, @IPPPHASE_III, -4971.55, -1148.57, 501.648, 2.28638, 0, 0, 0.909961, 0.414693, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- bandages - 5
(@OGUID+34, 180696, 0, 0, 0, 1, @IPPPHASE_III, -4958.51, -1179.32, 501.659, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL), -- skins - 5
(@OGUID+35, 180784, 0, 0, 0, 1, @IPPPHASE_III, -4913.85, -1226, 501.651, 2.25148, 0, 0, 0.902585, 0.430511, 180, 100, 1, 'gobject_ipp_we', 0, NULL),    -- bars - 5
(@OGUID+36, 180804, 0, 0, 0, 1, @IPPPHASE_III, -4937.29, -1282.74, 501.672, 2.26893, 0, 0, 0.906308, 0.422618, 180, 100, 1, 'gobject_ipp_we', 0, NULL); -- cooking and herbs - 5
