...
-- undo previous way of starting waypoints
UPDATE `creature_template` SET `flags_extra` = 0 WHERE `entry` IN (10991, 11678, 11837, 11839, 13959);-- DONT_OVERRIDE_SAI_ENTRY (134217728)  
