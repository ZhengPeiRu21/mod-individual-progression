...
INSERT INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (64, 2, 32649, 'You must possess the (Blessed) Medallion of Karabor to enter the Black Temple.', 2, 0, 0, NULL);
INSERT INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (64, 2, 32757, 'You must possess the (Blessed) Medallion of Karabor to enter the Black Temple.', 2, 1, 0, NULL);
